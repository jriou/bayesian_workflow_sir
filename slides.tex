...
\frame{
	...
	\begin{itemize}
		\item infer parameter values by \alert{integrating data and prior knowledge}
...
\frame{
	...
	\begin{figure}
		\centering
		\includegraphics[width=1\linewidth]{boarding_school/post_theta.pdf}
	\end{figure}
}
...
\frame{
	...
	\begin{figure}
		\centering
		\includegraphics[width=.65\linewidth]{boarding_school/inbed_fit.pdf}
	\end{figure}
}
