...
\author{Léo Grinsztajn, Charles Margossian, Julien Riou, Elizaveta Semenova}
...
\frame{
    ...
    \vspace{-7mm}
    \begin{center}
     \includegraphics[scale=0.6]{bayesian_workflow_sir/extension/transformed_parameters_0.png}
    \end{center}
    \textit{Model} block
    \vspace{-7mm}
    \begin{figure}
        \includegraphics[scale=0.6]{bayesian_workflow_sir/extension/model_0.png}
    \end{figure}
}
...
\frame{
    ...
    \begin{figure}
		\centering
		\includegraphics[scale=0.4]{bayesian_workflow_sir/extension/sir_diag.png}
	\end{figure}
	    \begin{figure}
		\centering
		\includegraphics[scale=0.13]{bayesian_workflow_sir/extension/swiss_fit1.png}
	\end{figure}
}
...
\frame{
    ...
    \begin{figure}
        \centering
        \includegraphics[scale=0.6]{bayesian_workflow_sir/extension/parameters_1.png}
    \end{figure}
    ...
    \vspace{-7mm}
        \begin{figure}
        \centering
        \includegraphics[scale=0.6]{bayesian_workflow_sir/extension/transformed_parameters_1.png}
    \end{figure}
    ...
    \begin{figure}
        \centering
        \includegraphics[scale=0.6]{bayesian_workflow_sir/extension/model_1.png}
    \end{figure}
}
...
\frame{
    ...
    \begin{figure}
        \centering
        \includegraphics[scale=0.2]{bayesian_workflow_sir/extension/underreporting.png}
    \end{figure}
}
...
\frame{
    ...
    \begin{figure}
        \includegraphics[scale=0.15]{bayesian_workflow_sir/extension/seir.jpeg}
    \end{figure}
    \begin{figure}
        \centering
        \includegraphics[0.6]{bayesian_workflow_sir/extension/seir_equations.png}
    \end{figure}
...
\frame{
    ...
    \begin{figure}
        \centering
        \includegraphics[scale=0.15]{bayesian_workflow_sir/extension/swiss_fit2.png}
    \end{figure}
}
...
\frame{
    ...
    \begin{figure}
        \centering
        \includegraphics[scale=0.2]{bayesian_workflow_sir/extension/a_distrib.png}
    \end{figure}
...
\frame{
    ...
    \begin{figure}
        \centering
        \includegraphics[scale=0.22]{bayesian_workflow_sir/extension/pair_plot.png}
    \end{figure}
}
...
\frame{
    ...
    \begin{figure}
        \hspace*{-0.9cm}
        \includegraphics[scale=0.58]{bayesian_workflow_sir/extension/transformed_parameters_sero.png}
    \end{figure}
    \newline
    \textit{model} block
    \vspace{-7mm}
    \begin{figure}
         \hspace*{-0.9cm}
        \includegraphics[scale=0.58]{bayesian_workflow_sir/extension/model_sero.png}
    \end{figure}
}
...
\frame{
    ...
    \begin{figure}
        \centering
        \includegraphics[scale=0.10]{bayesian_workflow_sir/extension/swiss_fit4.png}
    \end{figure}
}
