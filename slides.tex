...
\frame{
	...
	General principle of Bayesian inference\footnote{Gelman et al. \textit{Bayesian Data Analysis}}$^,$\footnote{Michael Betancourt, \textit{Introduction to Stan}}:
	\medskip
	\begin{itemize}
...
\bigskip
	...
	\begin{itemize}
		\item[-] prior predictive checking\footnote{Gabry et al. \textit{Visualization in Bayesian workflow}}
...
\frame{
	...
	\item try with other values to understand \alert{when does the model break}\footnote{Talts et al. \textit{Simulation-based calibration}}
	\end{itemize}
}
...
\frame{
	...
	Bayesian \alert{workflow}: model development as an iterative process\footnote{Gelman et al. \textit{Bayesian workflow}}
	\begin{figure}[htbp]
		\begin{center}
...
\frame{
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item \alert{simulation-based calibration}: does the model work as intended?
		\end{itemize}
...
\frame{
	...
	\begin{itemize}
		...
		\item Jonah Gabry et al., \textit{Visualization in Bayesian workflow} \\ \url{https://arxiv.org/abs/1709.01449}
		\item Sean Talts et al., \textit{Simulation-based calibration}  \\ \url{https://arxiv.org/abs/1804.06788}
